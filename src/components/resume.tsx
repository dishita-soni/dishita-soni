...
export default function Resume() {
  ...
  return (
          <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
            ...
            <section className="mb-8">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>Collaborated in teams to design, develop, and deliver projects, applying skills in Python, JavaScript, HTML/CSS, API integration, React, Express, and Figma to foster industry-ready problem-solving expertise. </li>
                </ul>
                <h4 className="mt-2 font-medium">Selected Project 1: <a href="https://github.com/PAP-2024-Fall-L5-BE-G1/Final-Project" className="text-primary underline">Selected Project 1: PAP-2025-Winter-L5-G1/Final-Project-Frontend on GitHub</a> (Winter 2024)</h4>
                <ul className="list-disc pl-6 space-y-1">
                  <li>Developed full-stack community forum with auth, filtering, and real-time post interactions using React and SQL.</li>
                  <li>Led front-end build and integrated backend features including likes, comments, and dynamic feeds. </li>
                </ul>
                <h4 className="mt-2 font-medium">Selected Project 2: <a href="https://pap-2024-summer-l4-fe-g1.github.io/L4-Final-Project/" className="text-primary underline">L4-Final-Project</a> (Summer 2024)</h4>
                <ul className="list-disc pl-6 space-y-1">
            ...
            <p className="text-xs text-center mt-5">Last updated: April 2025</p>
          </div>
        );
      }